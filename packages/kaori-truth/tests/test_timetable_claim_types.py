...
TYPES = {
    "space/asteroid_occultation_v1.yaml": ("space", "asteroid_occultation", 6, "sky", "PT1H", "2026-09-24T05:00Z"),
    "space/lunar_occultation_v1.yaml": ("space", "lunar_occultation", 6, "sky", "PT1H", "2026-09-24T05:00Z"),
    "earth/sentinel2_scene_v1.yaml": ("earth", "sentinel2_scene", 6, "surface", "PT1H", "2026-09-24T05:00Z"),
    "ocean/sentinel2_water_v1.yaml": ("ocean", "sentinel2_water", 6, "surface", "PT1H", "2026-09-24T05:00Z"),
    "ocean/sentinel3_olci_v1.yaml": ("ocean", "sentinel3_olci", 5, "surface", "PT1H", "2026-09-24T05:00Z"),
    "earth/sentinel1_sar_v1.yaml": ("earth", "sentinel1_sar", 6, "surface", "PT1H", "2026-09-24T05:00Z"),
}
...
def test_timetable_types_set_an_explicit_floor_and_an_hour_bucket():
    for name, (domain, topic, resolution, z_index, duration, bucket) in TYPES.items():
